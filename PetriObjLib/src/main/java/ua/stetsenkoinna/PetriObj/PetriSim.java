...
public class PetriSim implements Cloneable, Serializable {
    ...
    public PetriP[] getArray() {
        return listP;
    }

    public PetriP findPlace(String name) {
        for (PetriP p : listP) {
    ...
    public PetriT findT(String name) {
        for (var t : listT) {
    ...
    /**
     * This method solves conflict between transitions given in parametr
     * transitions
     *
